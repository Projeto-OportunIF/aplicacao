...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02/09/2025 às 18:28
...
(17, 'lucas', 'lucas@gmail.com', '105.296.209-28', '$2y$10$Nalp9m6.3oYEL7as0jyVtOe9Y.2TzH4z0gj6Fl6CI1CYzDALk/sKa', 'PROFESSOR', '20223024000', NULL, NULL),
(18, 'julie', 'julie@gmail.com', '105.296.209-28', '$2y$10$LsgKFGO6osNZW3Idu0hGNOEbvLGvpy5cp2t0UgTdiT0LXLYV2/Kc6', 'ALUNO', '20223024000', 1, NULL),
(19, 'luisa', 'luisa@gmail.com', '105.296.209-28', '$2y$10$BFnRww2o6VLAaXk1ou4pu.FCmX0epAByCYIn4U.bBU.1JPPB3dECC', 'ALUNO', '20223024000', 3, NULL);
...
--
ALTER TABLE `inscricoes`
  MODIFY `idInscricoes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `oportunidades`
  ADD CONSTRAINT `fk_oportunidades_usuarios1` FOREIGN KEY (`idUsuarios`) REFERENCES `usuarios` (`idUsuarios`) ON DELETE CASCADE ON UPDATE CASCADE;
