...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/11/2025 às 20:59
...
(39, '', NULL, 'PENDENTE', 32, 33, '2025-11-19 15:38:48');
...
--
ALTER TABLE `inscricoes`
  MODIFY `idInscricoes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT de tabela `notificacoes`
--
ALTER TABLE `notificacoes`
  MODIFY `idNotificacoes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
